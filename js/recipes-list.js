/* =========================================================================
   Kaki Lima — recipe listing (search + category filter)
   ========================================================================= */
(function () {
  ...
  function render() {
    ...
    grid.innerHTML = list.length
      ...
      : `<div class="state"><h3>Nichts gefunden</h3><p>Probier einen anderen Suchbegriff oder eine andere Kategorie.</p></div>`;
  }
  ...
  async function init() {
    ...
    try {
      ...
      grid.innerHTML = `<div class="state"><h3>Rezepte konnten nicht geladen werden</h3>
  ...
  if (searchEl) {
    let t;
    searchEl.addEventListener("input", e => { clearTimeout(t); query = e.target.value; t = setTimeout(render, 120); });
  }
  init();
})();
